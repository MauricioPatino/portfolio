...
import Logo from '../assets/mauricioLogoTrans.png';
import { Menu, X } from 'lucide-react';
export const Navbar = () => {

const [mobileMenuOpen,setaMobileMenuOption] = useState(false);
  return (
        ...
        <div className='max-w-7xl mx-auto flex h-14 items-center'>
            <div className='md:mr-4 flex justify-between w-full'>
                <a href='#' className='mr-6 flex items-center space-x-2'>
                    <img src={Logo} alt='My logo' className='w-36' />
                </a>
                <nav className='md:flex hidden items-center space-x-6 text-lg font-medium'>
                    ...
                    <a href='#contact' className='transition-colors hover:text-foreground/80 text-foreground/60'>Contact me</a>
                </nav>
            </div>
            <button className='inline-flex items-center justify-center rounded-md md:hidden' onClick={()=>setaMobileMenuOption(!mobileMenuOpen)}>
